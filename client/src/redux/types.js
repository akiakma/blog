...
export const NEWS_WRITE_FAILURE = "NEWS_WRITE_FAILURE";
...
// NEWS UPLOAD
export const NEWS_UPLOADING_REQUEST = "NEWS_UPLOADING_REQUEST";
export const NEWS_UPLOADING_FAILURE = "NEWS_UPLOADING_FAILURE";
export const NEWS_UPLOADING_SUCCESS = "NEWS_UPLOADING_SUCCESS";

// NEWS Detail loading
export const NEWS_DETAIL_LOADING_REQUEST = "NEWS_DETAIL_LOADING_REQUEST";
export const NEWS_DETAIL_LOADING_FAILURE = "NEWS_DETAIL_LOADING_FAILURE";
export const NEWS_DETAIL_LOADING_SUCCESS = "NEWS_DETAIL_LOADING_SUCCESS";
// NEWS DELETE
...
// NEWS Loading Edit
export const NEWS_EDIT_LOADING_REQUEST = "NEWS_EDIT_LOADING_REQUEST";
export const NEWS_EDIT_LOADING_FAILURE = "NEWS_EDIT_LOADING_FAILURE";
export const NEWS_EDIT_LOADING_SUCCESS = "NEWS_EDIT_LOADING_SUCCESS";

// NEWS Uploading Edit
export const NEWS_EDIT_UPLOADING_REQUEST = "NEWS_EDIT_UPLOADING_REQUEST";
export const NEWS_EDIT_UPLOADING_FAILURE = "NEWS_EDIT_UPLOADING_FAILURE";
export const NEWS_EDIT_UPLOADING_SUCCESS = "NEWS_EDIT_UPLOADING_SUCCESS";

// Badge Count
export const BADGE_UPLOADING_REQUEST = "BADGE_UPLOADING_REQUEST";
export const BADGE_UPLOADING_SUCCESS = "BADGE_UPLOADING_SUCCESS";
export const BADGE_UPLOADING_FAILURE = "BADGE_UPLOADING_FAILURE";
